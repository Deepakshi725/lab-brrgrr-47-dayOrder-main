...
function renderPrice() {
  let PriceOfPatty = 80;
  let PriceOfCheese = 10;
  let PriceOfTomato = 10;
  let PriceOfOnion = 10;
  let PriceOfLettuce = 10;

  var total_amount = price +
    (state.Patty * PriceOfPatty) +
    (state.Cheese * PriceOfCheese) +
    (state.Tomatoes * PriceOfTomato) +
    (state.Onions * PriceOfOnion ) +
    (state.Lettuce * PriceOfLettuce);
  document.querySelector(".price-details").innerText = "INR " + total_amount;
}
